...
BOOST_AUTO_TEST_CASE(chain){
    ...
    check(m0(1, 4.5).m3(4, 2.7, "hi")[1].o4.m5(), "m0(1, 4.5).m3(4, 2.7, 'hi')[1].o4.m5()");
    check(m0(1, 4.5).m3(4, 2.7, "hi")[1].o4.m5(42) - m0(1, 4.5).m3(4, 2.7, "hi")[1].o4 + fn * m0, "m0(1, 4.5).m3(4, 2.7, 'hi')[1].o4.m5(42) - m0(1, 4.5).m3(4, 2.7, 'hi')[1].o4 + fn * m0");
    check((m0(1, 4.5) , m0(1, 4.5).m1(4, 2.7) , m0(1, 4.5).m3(4, 2.7, "hi")[1].o4), "m0(1, 4.5);m0(1, 4.5).m1(4, 2.7);m0(1, 4.5).m3(4, 2.7, 'hi')[1].o4");
}
